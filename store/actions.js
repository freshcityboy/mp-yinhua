...
const {reqDetailInfo, reqRecommend, reqVideoUrl, reqAllDetailInfo, reqDanMu, addNewDoc} = api  // 这里要注意，用export default 暴露出的对象，不能在import时直接解构

export default { 
  async getRecommend ({ commit },num) {
    const result = await reqRecommend(num=0)
